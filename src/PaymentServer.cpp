...
const QString BITCOIN_IPC_PREFIX("darkcrystal:");

static QString ipcServerName()
{
    QString name("darkcrystal");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start darkcrystal: click-to-pay handler");
    else
...
{
    // clicking on DarkCrystal: URLs creates FileOpen events on the Mac:
